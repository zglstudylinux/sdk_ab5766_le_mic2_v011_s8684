/*****************************************************************************
 * Module    : Config
 * File      : config_ab5700_kbox.h
 * Function  : 搭配AB5700的无线话筒配置文件
 *****************************************************************************/

#ifndef CONFIG_AB5700_KBOX_H
#define CONFIG_AB5700_KBOX_H
...
#define BSP_VBAT_DETECT_EN              1//1                     //电池电量检测
...
#define WIRELESS_CON_VERS                       2                         //传输机制版本（只支持2，即V3传输机制）
...
#define WIRELESS_MIC_TX_INTERVAL                12              //传输周期=n*1.25ms（默认值是2，改为4时传输次数可增加到3次）
...
#define WIRELESS_MIC_DAC_OUT_EN                 0               //发射端侦听麦采集使能
#define WIRELESS_MIC_CLOSE_EN                   0               //发射端是否关闭，只用于接收端优化对应空间
#define WIRELESS_MIC_K12_KEY_EN                 1               //发射端使用k12方案默认按键
...
#define WIRELESS_MIC_EQ_DRC_DELAY               WIRELESS_MIC_EQ_DRC_EN*170//EQ_DRC运算时间
...
//适配器端私有配置
#define ADAPTER_DAC_OUTPUT_EN                   0               //适配器是否支持dac输出MIC音频
...
#define ADAPTER_CLOSE_EN                        1               //适配器是否关闭
